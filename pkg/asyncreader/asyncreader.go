...
// ErrStreamAbandoned is returned when the input is closed before the end of the stream
var ErrStreamAbandoned = errors.New("stream abandoned")
...
func New(_ context.Context, rd io.ReadCloser, buffers int) (*AsyncReader, error) {
	if buffers <= 0 {
